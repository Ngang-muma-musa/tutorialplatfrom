	...
	<div class="container">
		...
		<div id="test1" class="col s12"><br>
			  <ul class="collection">
			      ...
			      <span class="title"><b>Add Topic </b></span>
			     <a href="#modal2" class="modal-trigger secondary-content"><i class="material-icons">add</i></a>
			    </li>
			    <?php
			    if (mysqli_num_rows($result2)==0) {
			    	echo "<h4 class='blue center-align'>No topic has been posted for this course</h4>";
			    }
                 while ($row = mysqli_fetch_assoc($result2)) {
                 	...
                 	?>
				      ...
				      <p><?php echo $date; ?></p>
				      <a href="topic_material.php?topicId=<?php echo($topicId);?>" class="btn black  secondary-content">Details</a>
				    </li>
                 	<?php
